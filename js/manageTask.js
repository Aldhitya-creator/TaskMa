document.addEventListener('DOMContentLoaded', ()=> {
    ...
    function displayAllTasks(tasks = existingTasks){
        if (tasks.length === 0 ){
            ...
            console.log("kosong tidak ada task")
        }else{
            ...
            const completeTaskButton = itemTask.querySelector(`#completeTask-${task.id}`);
            ...
            const deleteTaskButton = itemTask.querySelector(`#deleteTask-${task.id}`);
            if (deleteTaskButton) {
